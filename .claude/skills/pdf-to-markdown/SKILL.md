...
cd .claude/skills/pdf-to-markdown && python3 -m venv .venv && .venv/bin/pip install pymupdf pymupdf4llm

# For --docling mode (high-accuracy tables):
cd .claude/skills/pdf-to-markdown && python3 -m venv .venv && .venv/bin/pip install pymupdf docling docling-core

# Or install everything:
cd .claude/skills/pdf-to-markdown && python3 -m venv .venv && .venv/bin/pip install pymupdf pymupdf4llm docling docling-core
```
...
```bash
test -d .claude/skills/pdf-to-markdown/.venv || (cd .claude/skills/pdf-to-markdown && python3 -m venv .venv && .venv/bin/pip install pymupdf pymupdf4llm)
```
...
```bash
# For fast mode:
cd .claude/skills/pdf-to-markdown && rm -rf .venv && python3 -m venv .venv && .venv/bin/pip install pymupdf pymupdf4llm

# For docling mode:
cd .claude/skills/pdf-to-markdown && rm -rf .venv && python3 -m venv .venv && .venv/bin/pip install pymupdf docling docling-core
```
